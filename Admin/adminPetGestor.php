...
?>
	<html>
		...
		<a href='admin.php' > <img src="../img/logoeve.png" id="imagen"/> </a>
				...
				<div id="titulo">
					<h1> Admin </h1>	
					<h2>Gestion de peticiones de eventos </h2>
					<br>
					</div>
					<div id="listaEventos">
					<?php 
						...
						<ul>
							...
							<li>
								...
								<?php echo "<a href='../Eventos/descripcionV.php?id=$valor'>"; ?>  <img id="fotoEvento" src="../img/evento-icon.jpg"/></a>
								 ...
								 <a <?php echo "<a href='../Eventos/aceptarEvento.php?id=$arr[0]'>"; ?> <button id="rechazar">Aceptar</button> </a>
								  <a <?php echo "<a href='../Eventos/eliminarEvento.php?id=$arr[0]'>"; ?> <button id="modificar">Rechazar(Eliminar)</button> </a>
								  <br>
								<br>
