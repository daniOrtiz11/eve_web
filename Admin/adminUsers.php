		...
		<a href='admin.php' > <img src="../img/logoeve.png" id="imagen"/> </a>
				...
				<div id="personas">
						<ul>
							...
							<li>
								<?php echo "<a href='../Perfil/verperfil.php?id=$valor'>"; ?> <h2><?php echo $arr[10] ?> </h2> 	</a>
								<?php echo "<a href='../Perfil/verperfil.php?id=$valor'>"; ?>  <img id="fotoEvento" src="../img/Misc-User-icon.png"/></a>
								 <a <?php echo "<a href='../Perfil/verperfilV.php?id=$valor'>"; ?> <button id="aceptar">Ver usuario</button> </a>
								 <a <?php echo "<a href='../Perfil/verperfil.php?id=$arr[0]'>"; ?> <button id="rechazar">Modificar</button> </a>
								  <a <?php echo "<a href='../Perfil/eliminarUser.php?id=$arr[0]'>"; ?> <button id="modificar">Eliminar</button> </a>
								  <br>
								<br>
